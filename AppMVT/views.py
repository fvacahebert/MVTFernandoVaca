...
def familia(request):
    familiar1=Familia(DNI=37497802,nombre="Fernando",paretezco="Hijo",fecha_de_cumpleaños=1993/10/14)
    ...
    familiar2.save()
    familiar3.save()
    fliar1=f"DNI: {familiar1.DNI} Nombre: {familiar1.nombre} Parentezco: {familiar1.paretezco} Cumpleaños: {familiar1.fecha_de_cumpleaños}"
...
def TemplateMVT(self):
    Ruta=open("C:/Users/fvaca/OneDrive - SA San Miguel A.G.I.C.I. y F/Escritorio/Fer/Otros/Cursos/Python/CH/Clase 17 - 18/MVT-Entregable\MVTFernandoVaca/Plantillas/TemplateMVT.html")
